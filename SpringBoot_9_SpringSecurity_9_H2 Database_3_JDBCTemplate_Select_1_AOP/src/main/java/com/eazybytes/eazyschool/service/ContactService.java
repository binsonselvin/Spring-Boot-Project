...
public class ContactService {
	...
	public List<Contact> findMsgsWithOpenStatus() {
		return contactRepository.findMsgsWithOpenStatus(EazySchoolConstants.OPEN);
	}

	public boolean closeContactMessage(String contactId, String updatedBy) {
		int updatedCount = contactRepository.closeContactMessage(Integer.parseInt(contactId), updatedBy, EazySchoolConstants.CLOSE );
		if(updatedCount > 0) {
			return true;
		} else {
			return false;
